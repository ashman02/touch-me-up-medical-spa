...
const Footer = () => {
    return (
        <footer className="my-container bg-foreground text-background space-y-40 py-20 md:space-y-48 md:py-24 lg:space-y-64 lg:py-32">
            <div className="first-part flex flex-col gap-20 md:gap-24 lg:flex-row lg:items-start lg:justify-between">
                ...
                <div className="address-social flex flex-col gap-6 md:gap-12 lg:gap-16">
                    <div className="address flex flex-col gap-6 md:flex-row md:justify-between lg:gap-14">
                        {footerData.addresses.map((add) => (
                            ...
                            >
                                ...
                                <div className="add paragraph-text flex flex-wrap gap-2 md:flex-col md:flex-nowrap md:gap-0">
                                    <p>{add.street}</p>
                                    <p>{add.city}</p>
                                    <p>{add.state}</p>
                                </div>
                    ...
                    <div className="social flex flex-col gap-3 md:gap-4 lg:gap-5">
                        ...
                        <div className="paragraph-text flex gap-2">
                            {socials.map((s) => (
                                <Link
                                    key={s.name}
                                    href={s.link}
            ...
            <div className="copy-policy flex flex-col gap-6 text-gray-400 lg:flex-row lg:justify-between">
